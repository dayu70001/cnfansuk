/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/catalog-api/wrangler.toml workers/catalog-api/worker-configuration.d.ts` (hash: 89daa4662584e9d4019cdbf826331290)
