...
export default async function OrderSuccessPage({
  ...
  const whatsappLink = getWhatsappLinkFromSettings(settings, order);
  const telegramLink = getTelegramLinkFromSettings(settings, order);
  ...
  return (
    <section className="success-wrap">
      ...
      <div className="success-actions">
        <a className="chan success-whatsapp" href={whatsappLink} target="_blank" rel="noreferrer">
        ...
        <a className="chan success-telegram" href={telegramLink} target="_blank" rel="noreferrer">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="#fff" aria-hidden="true">
