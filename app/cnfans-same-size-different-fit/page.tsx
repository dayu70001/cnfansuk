...
const guide = getPhaseFourGuide("/cnfans-same-size-different-fit");
export const metadata: Metadata = buildGuideMetadata({ path: guide.path, title: guide.title, description: guide.description });
export default function CnfansSameSizeDifferentFitPage() { return <LongTailGuidePage guide={guide} />; }
