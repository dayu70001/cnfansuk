...
const guide = getPhaseFourGuide("/cnfans-product-photos-vs-qc-photos");
export const metadata: Metadata = buildGuideMetadata({ path: guide.path, title: guide.title, description: guide.description });
export default function CnfansProductPhotosVsQcPhotosPage() { return <LongTailGuidePage guide={guide} />; }
