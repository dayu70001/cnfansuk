...
const guide = getPhaseFourGuide("/cnfans-spreadsheet-search-tips");
export const metadata: Metadata = buildGuideMetadata({ path: guide.path, title: guide.title, description: guide.description });
export default function CnfansSpreadsheetSearchTipsPage() { return <LongTailGuidePage guide={guide} />; }
