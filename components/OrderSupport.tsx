  ...
  return (
    <section className="support-band" aria-labelledby="support-title">
      <div>
        ...
        <h2 id="support-title">WhatsApp or Telegram Order Support</h2>
        <p>Direct order support helps us verify size, stock, delivery details and payment instructions before payment.</p>
      </div>
      <div className="button-row">
        <MetaPixelEventLink
          className="chan chan-wa"
          href={getWhatsappLink()}
          target="_blank"
          rel="noreferrer"
          eventName="CheckoutWhatsAppContact"
          eventParams={{
            source_page: "order_support",
            placement: "order_support_whatsapp",
        ...
        <MetaPixelEventLink
          className="chan chan-tg"
          href={getTelegramLink()}
          target="_blank"
          rel="noreferrer"
          eventName="CheckoutTelegramContact"
          eventParams={{
            source_page: "order_support",
            placement: "order_support_telegram",
